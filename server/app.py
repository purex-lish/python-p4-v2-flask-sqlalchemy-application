...
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False # set to false avoid unhelpful data build up
...
# add views here 
#determines which resources are available at which URLs and saves them to the application's URL map.
@app.route('/')
def index():
